...
<x-form.field>
    ...
    <trix-editor
        ...
        toolbar="{{ $id }}_toolbar"
        input="{{ $id }}_input"
        {{ $attributes->merge(['class' => 'trix-content px-3 py-2 border border-border ring-0 text-text bg-primary-background focus:border-border rounded-md shadow-sm focus:border-b-4 focus:border-b-secondary-background ']) }}
