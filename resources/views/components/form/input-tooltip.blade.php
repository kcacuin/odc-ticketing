...
@php
    $classes = 'block mt-1 w-full peer h-[3rem] px-6 text-base text-white bg-gray-dark rounded-lg border-opacity-75 border-2 outline-none placeholder-gray-300 placeholder-opacity-0 transition duration-200 placeholder-transparent placeholder:pointer-events-none
    ring-0 placeholder:select-none focus:shadow-md focus:shadow-odc-blue-700 focus:border-blue-secondary focus:ring-0';
    $errorClasses = 'block mt-1 w-full peer h-[3rem] px-6 text-base text-white bg-gray-dark rounded-lg border-red-primary border-2 outline-none placeholder-gray-300 placeholder-opacity-0 transition duration-200 placeholder-transparent placeholder:pointer-events-none ring-0 placeholder:select-none focus:border-red-primary focus:ring-0';
@endphp
        ...
        <div class="absolute top-0 right-3 translate-y-1/2">
            <div x-data="{ tooltip: false }" class="relative z-30 inline-flex">
                ...
                <div x-cloak x-show.transition.origin.top="tooltip">
                    <div class="info-tooltip absolute max-w-2xl ring-1 ring-slate-400 whitespace-nowrap -top-2 left-1/2 z-10 p-2 -mt-1 text-sm font-medium leading-tight text-white transform -translate-x-1/2 -translate-y-full bg-gray-dark rounded-lg shadow-lg">
                    {{ $tooltip }}
                    </div>
                </div>
            </div>
