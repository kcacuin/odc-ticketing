...
@php
    $classes = 'peer block mt-1 w-full peer h-[3rem] px-6 text-sm text-text bg-primary-background rounded-e-lg border-border border-2 outline-none placeholder-gray-300 placeholder-opacity-0 transition duration-200 placeholder-transparent placeholder:pointer-events-none
    ring-0 placeholder:select-none focus:shadow-md focus:shadow-odc-blue-700 focus:border-blue-secondary focus:ring-0';
    $errorClasses = 'peer block mt-1 w-full peer h-[3rem] px-6 text-sm text-text bg-primary-background rounded-lg border-red-primary border-2 outline-none placeholder-gray-300 placeholder-opacity-0 transition duration-200 placeholder-transparent placeholder:pointer-events-none ring-0 placeholder:select-none focus:border-red-primary focus:ring-0';
@endphp

<x-form.field>
    <div class="relative">
        <div class="flex rounded-md shadow-sm ">
            <span class="inline-flex items-center px-3 rounded-l-md border-2 border-r-0 border-border  text-slate-500 sm:text-xs peer-focus:shadow-md peer-focus:shadow-odc-blue-700">
