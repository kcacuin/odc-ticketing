...
<x-form.field>
    <div class="relative">
        <div class="flex rounded-md shadow-sm ">
            <span class="inline-flex items-center px-3 rounded-l-md border-2 border-r-0 border-opacity-75  text-slate-500 sm:text-xs peer-focus:shadow-md peer-focus:shadow-odc-blue-700">
